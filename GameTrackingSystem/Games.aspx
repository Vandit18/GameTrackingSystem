        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" CssClass="form-control" ID="TeamAScore" placeholder="TeamAScore"  ></asp:TextBox>
                </div>
                <div class="form-group">
                    <label class="control-label" for="TeamBScore">TeamB Score</label>
                    <asp:TextBox runat="server" CssClass="form-control" ID="TeamBScore" placeholder="TeamBScore" ></asp:TextBox>
                </div>
                <div class="form-group">
                    <label class="control-label" for="Spectators">Spectators</label>
                    <asp:TextBox runat="server" CssClass="form-control" ID="Spectators" placeholder="Spectators"></asp:TextBox>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" TextMode="DateTime" CssClass="form-control" ID="GameDateTextBox" placeholder="Game Date Format: mm/dd/yyyy" required="true"></asp:TextBox>
